...
> توجه: یک پارتیشن Extended فقط یک جعبه خالی برای ایجاد پارتیشن‌های Logical داخل آن است.
...
> اگر یک پارتیشن extended روی سیستم BIOS تعریف کنید، آن `/dev/sdx5` خواهد بود (1-4 برای primary، و اولین extended 5 خواهد بود).
...
> توجه: parted GPT را درک نمی‌کند
...
> توجه: فرمول دقیقی برای اندازه swap وجود ندارد. مردم می‌گفتند "دو برابر رم اما نه بیشتر از 8GB". روی ماشین‌های اخیر با SSDها، برخی می‌گویند "RAM + 2" (Hibernation + کمی اضافی) یا "RAM * 2" بسته به کاربرد شما.
