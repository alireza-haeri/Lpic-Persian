...
من به شدت توصیه می‌کنم در tmux مهارت پیدا کنید. فوق‌العاده مفید است حتی وقتی به صورت محلی روی ماشین خود کار می‌کنید. ویدیو زیر را برای session عمیق‌تر ببینید:
