...
مجوزهای فایل یکی از مهم‌ترین مفاهیم امنیتی در لینوکس است.

## درک مجوزها

سه نوع مجوز برای هر فایل:
...
1. یک فایل متنی ایجاد کنید و مجوزهای آن را به `rw-r--r--` تنظیم کنید
2. یک اسکریپت ایجاد کنید و قابل اجرا کنید
3. مجوزهای فایل‌ها را با `ls -l` بررسی کنید

## نکات امنیتی

⚠️ **نکات مهم:**

- از `chmod 777` بدون دلیل استفاده نکنید
- فایل‌های حساس: مجوز `600` یا `400`
